...
class CellPhoneSpider(scrapy.Spider):
	...
	start_urls = ["http://www.amazon.com/s/ref=sr_nr_i_2?srs=3837915031&fst=as%3Aoff&rh=i%3Aspecialty-aps%2Ci%3Agarden&ie=UTF8&qid=1462187384"]

	def parse(self, response):
		print "\n\n response : ", response.headers.getlist
		html = response.body
